...
begin
	...
	if File.file?(Val::Files.bookinfo_file)
		run_script("#{Val::Resources.powershell_exe} \"#{Val::Resources.run_macro} \'#{Val::Doc.input_file}\' \'#{macro_name}\' \'#{logfile}\'\"", output_hash, "Val::Resources.run_macro", json_logfile)
	else
		output_hash['Val::Files.bookinfo_file'] = false 
